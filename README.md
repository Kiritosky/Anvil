...
| Coding | Zahlensysteme, Zeichen (Unicode), Dateirechte, HTTP-Codes, Cron, Tabellen (CSV/TSV), Netzrechner (IPv4/IPv6), Patch (Diff lesen und anwenden), Testdaten |
| Alltag | Bildschirmfoto, Zwischenablage-Verlauf, Farben, QR-Code, Text aus Bild, Bild umwandeln, Passwörter, Einheiten, Prozent, Zeitzonen, Blindtext, Zeitrechner, Umbenennen im Stapel |
| System | Tool-Store |
