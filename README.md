...
| Coding | Zahlensysteme, Zeichen (Unicode), Dateirechte, HTTP-Codes, Cron, Tabellen (CSV/TSV), Netzrechner (IPv4/IPv6) |
| Alltag | Bildschirmfoto, Zwischenablage-Verlauf, Farben, QR-Code, Text aus Bild, Bild umwandeln, Passwörter, Einheiten, Prozent, Zeitzonen, Blindtext, Zeitrechner |
| System | Tool-Store |
