...
| Coding | Zahlensysteme, Zeichen (Unicode), Dateirechte, HTTP-Codes, Cron, Tabellen (CSV/TSV), JSON ↔ YAML ↔ TOML, Netzrechner (IPv4/IPv6), Patch (Diff lesen und anwenden), Repositories (alle Git-Ordner auf einmal), Testdaten |
